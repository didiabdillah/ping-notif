$(function () {
    ...
    //             a &&
    //                 (t.append("<div class='todo-box'><i class='remove fa fa-trash-o'></i><div class='todo-task'><label class='ckbox'><input type='checkbox'/><span>" + a + "</span><i class='input-helper'></i></label></div></div>"),
    //                 o.val(""));
    //         }),
